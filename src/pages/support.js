        ...
        <div className='w-[100%] md:w-[72vw] lg:w-[78vw] lg:h-[500px] md:h-[453px] sm:h-[353px] flex flex-col  justify-center bg-white rounded-[25px] '>
          <div className='flex ss:flex-row flex-col items-center'>
            ...
            <div className='flex flex-col  '>
              ...
              <p className='flex justify-center items-center text-[#707070] text-center ss:text-[10px] sm:text-xs lg:text-sm  font-normal font-poppins mt-2'>
                Need support? Find out how we can serve you better
              </p>
              <div className='flex  justify-center items-center ss:flex-row flex-col gap-5 ss:gap-10 lg:gap-20 mt-10'>
              
                <div className='flex justify-center items-center gap-3 ss:gap-1 lg:gap-2 border-[1px] border-[#232164] rounded-[5px] w-[90%]  ss:w-[180px] md:w-[220px]   pt-2 lg:pt-3 pb-2'>
                  <div className='bg-[#0257C0] w-[35px] h-[35px] ss:w-[25px] sm:w-[30px] lg:w-[35px] sm:h-[30px] ss:h-[25px] lg:h-[35px] flex justify-center items-center rounded-[10px]'>
                    <img className='sm:w-[16px] ss:w-[14px] lg:w-[18px]' src={chat} alt='' />
                  </div>
                  <div>
                    <h4 className='font-poppins ss:text-xs lg:text-[14px] '>Chat</h4>
                    <h5 className='text-[#707070] ss:text-[10px] lg:text-[12px]'>
          ...
          <div className="md:w-[72vw] mt-5 lg:w-[78vw] flex justify-center items-center">
